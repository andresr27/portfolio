...
- **AWS:** Production experience designing and operating high availability multi‑region AWS networks, with a strong focus on monitoring and management using CloudWatch, CloudTrail, and third‑party tools.
...
**Operational Excellence & Monitoring:** I believe in building systems that are not only scalable and secure but also observable and easy to troubleshoot. I implement comprehensive monitoring and alerting solutions using tools like Prometheus, Grafana, and AWS CloudWatch to provide real‑time visibility into infrastructure and platform health, enabling proactive issue resolution and minimizing downtime.
